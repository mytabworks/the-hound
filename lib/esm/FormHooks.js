...
var useGetAllValue = function useGetAllValue() {
  var store = (0, _react.useContext)(FormContext);
  var state = useStore(store, function (states) {
    return states.fields;
  }, true);
  return (0, _react.useMemo)(function () {
    return (0, _utils.transformFieldsToJSON)(state);
  }, [state]);
};

exports.useGetAllValue = useGetAllValue;
...
var useFormGenericSetStateMethods = function useFormGenericSetStateMethods(store) {
  ...
  var setSafeFieldValues = (0, _react.useCallback)(function (fieldValues) {
    store.setState(function (prev) {
      var fields = Object.keys(fieldValues).reduce(function (result, name) {
        var value = fieldValues[name];
        return (0, _utils.validateField)(result, {
  ...
  var setSafeFieldValue = (0, _react.useCallback)(function (name, value) {
    store.setState(function (prev) {
      return _objectSpread(_objectSpread({}, prev), {}, {
        fields: (0, _utils.validateField)(prev.fields, {
          name: name,
  ...
  return {
    ...
    setFieldValue: setFieldValue,
    setFieldValues: setFieldValues,
    setSafeFieldValues: setSafeFieldValues,
    setSafeFieldValue: setSafeFieldValue,
    setFieldError: setFieldError,
    setFieldErrors: setFieldErrors,
    clearFieldError: clearFieldError,
    clearFieldErrors: clearFieldErrors,
